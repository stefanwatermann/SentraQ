...
Protected Class DataService
	...
	#tag Method, Flags = &h21
		Private Sub ReadAndCacheComponents(station as StationModel)
		  // read all components from the vComponentLast view of the given station
	...
	#tag Method, Flags = &h21
		Private Sub ReadAndCacheStations()
		  Var apiClient As New BackendApiControllerClient

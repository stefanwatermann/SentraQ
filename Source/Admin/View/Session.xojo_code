...
#tag EndSession
	...
	#tag Method, Flags = &h21
		Private Sub NavigateTo(hashtag as string)
		  ...
		  Else
		    ...
		    Self.PageHandler.ShowPage(Self.Hashtag)
	...
	#tag Constant, Name = kMinClientWidth, Type = Double, Dynamic = False, Default = \"450", Scope = Private, Description = 4D696E696D756D2073697A65206F66207468652065787065637465642062726F777365722077696E646F772E
	#tag EndConstant

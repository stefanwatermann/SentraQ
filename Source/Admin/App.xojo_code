...
Inherits LobBase.LobWebApplication
	...
	#tag Event
		Sub Opening(args() as String)
		  ...
		  InitApp("Sentraq-Admin", "Watermann IT, Germany", App.ApiAuthKeyValue)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  return "SentraQ Admin - (c) " + str(DateTime.Now.Year) + " Watermann IT, Auetal"
			End Get
		#tag EndGetter

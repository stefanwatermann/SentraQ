...
Begin WebContainer UserInfoContainer
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   CSSClasses      =   ""
   ...
   Begin WebLabel lbUserRole
      ...
      _mPanelIndex    =   -1
   End
   Begin WebButton btnRequestPwdReset
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub Constructor(user as UserModel)
		  Self.CurrentUser = user
		  Self.lbUserRole.Text = user.RoleName
		  Self.lbUserEmail.Text = user.Email
